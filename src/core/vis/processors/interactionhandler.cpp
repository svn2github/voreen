...
void InteractionHandler::activate(){
    setEventTypes(defaultEventTypes_);
}

void InteractionHandler::deactivate(){
    setEventTypes(0);
}

void InteractionHandler::setDefaultEventTypes(int defaultEventTypes){
    defaultEventTypes_ = defaultEventTypes;
}

int InteractionHandler::getDefaultEventTypes(){
    return defaultEventTypes_;
}
