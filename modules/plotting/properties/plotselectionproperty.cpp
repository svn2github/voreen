...
Variant PlotSelectionProperty::getVariant(bool) const {
    Variant result;
    result.set<std::vector<PlotSelectionEntry> >(get(), Variant::VariantTypeUserType + 1); 
    return result;
}

void PlotSelectionProperty::setVariant(const Variant& val, bool) {
    std::vector<PlotSelectionEntry> targetNewVec = val.get<std::vector<PlotSelectionEntry> >();
    std::vector<PlotSelectionEntry> targetOldVec = get();
...
int PlotSelectionProperty::getVariantType() const {
