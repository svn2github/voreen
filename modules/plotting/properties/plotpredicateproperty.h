...
template class VRN_MODULE_PLOTTING_API TemplateProperty<std::vector<std::pair<int, PlotPredicate*> > >;
#endif
 ...
 **/
class VRN_MODULE_PLOTTING_API PlotPredicateProperty : public TemplateProperty<std::vector<std::pair<int, PlotPredicate*> > > {
public:
