...
protected:
    ...
    const FlowVolume* checkVolumeHandleForFlowData(const VolumeHandleBase* const candidate, bool& changed) {
        ...
        return dynamic_cast<const FlowVolume*>(currentVolumeHandle_->getRepresentation<Volume>());
    }
