...
#include "tgt/freetype.h"

#ifdef TGT_HAS_FREETYPE
    //FreeType Headers
    #include <ft2build.h>
...
void make_dlist(FT_Face face, char ch, GLuint list_base, GLuint * tex_base) {
	...
	// Here we fill in the data for the expanded bitmap. Notice that we are using two channel bitmap
    // (one for luminocity and one for alpha), but we assign both luminocity and alpha to the value
    // that we find in the FreeType bitmap.
	...
	// (this is only true for characters with a descender).
...
#endif // TGT_HAS_FREETYPE


#ifndef TGT_HAS_FREETYPE
