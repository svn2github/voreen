...
//    , plotLib_()
    ...
    , plotLibraryViewPortClipping_(true)
{
...
void PlotProcessor::switchPlotLibrary() {
    ...
    plotLib_->setViewPortClipping(plotLibraryViewPortClipping_);
    setPlotStatus();
    // start function 
...
void PlotProcessor::setViewPortClipping(bool clipping) {
    plotLibraryViewPortClipping_ = clipping;
}
