...
void main() {
    ...
    vec2 gradient = textureLookup2Dscreen(shadeTex_, texParams_, fragCoord.xy).xy;

    float gradientLength = length(gradient);
    gradientLength = textureLookup2Dscreen(shadeTex_, texParams_, fragCoord.xy).b;
    ...
    float forwardNeighbor = textureLookup2Dscreen(shadeTex_, texParams_, fragCoord.xy+offset).b;
    float backwardNeighbor = textureLookup2Dscreen(shadeTex_, texParams_, fragCoord.xy-offset).b;
