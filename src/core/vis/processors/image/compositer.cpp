    ...
    , blendFactor_("Compositer.set.blendFactor", "Blend factor", 0.5f, 0.0f, 1.0f, true)
{
    ...
    compositingMode_ = new EnumProp("Compositer.set.blendMode", "Set blend mode:", compositingModes_, &needRecompileShader_, 0, false);
...
void Compositer::processMessage(Message* msg, const Identifier& dest) {
