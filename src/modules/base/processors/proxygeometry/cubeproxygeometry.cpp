...
CubeProxyGeometry::CubeProxyGeometry()
    ...
    , clipLeftX_(setLeftClipPlane_, "Left clipping plane (x)", 0.0f, 0.0f, 10000.0f, true)
    , clipRightX_(setRightClipPlane_, "Right clipping plane (-x)", 0.0f, 0.0f, 1000.0f, true)
    , clipFrontY_(setBottomClipPlane_, "Front clipping plane (y)", 0.0f, 0.0f, 10000.0f, true)
    , clipBackY_(setTopClipPlane_, "Back clipping plane (-y)", 0.0f, 0.0f, 10000.0f, true)
    , clipBottomZ_(setFrontClipPlane_, "Bottom clipping plane (z)", 0.0f, 0.0f, 10000.0f, true)
    , clipTopZ_(setBackClipPlane_, "Top clipping plane (-z)", 0.0f, 0.0f, 10000.0f, true)
